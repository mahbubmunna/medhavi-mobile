...
import 'package:trial1/services/khalti.dart';
                            ...
                            children: <Widget>[
                              RichText(
                                text: TextSpan(children: [
                                  ...
                                  TextSpan(
                                      text: 'Npr. ' +
                                          "${userProvider.userModel.cart[index].price + 0.5} \n\n",
                                      style: TextStyle(
                                          color: black,
                                          fontSize: 18,
            ...
            children: <Widget>[
              RichText(
                text: TextSpan(children: [
                  ...
                  TextSpan(
                      text: 'Npr. ' +
                          " ${userProvider.userModel.totalCartPrice + 0.5}",
                      style: TextStyle(
                          color: black,
                          fontSize: 22,
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        'Your total bill is Npr. ${userProvider.userModel.totalCartPrice} ',
                                        textAlign: TextAlign.center,
                                      ),
                                      SizedBox(
                                        width: 320.0,
